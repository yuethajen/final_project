...
def print_outcomes(simOutput, therapy_name):
    ...
    # print outcomes
    print(therapy_name)
    print("  Estimate of total  patient exposure time to antibiotics (days):", survival_total_text)
...
def print_comparative_outcomes(simOutputs_mono, simOutputs_combo):
    ...
    print("Increase in total antibiotics exposure time (day):", increase_exposure_time)
    ...
    estimate_CI = F.format_estimate_interval(
        ...
        deci=2)
    print("Average change in antibiotic exposure time (day) "
